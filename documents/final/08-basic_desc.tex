...
In figure \cref{fig:desc-host_listings_count-hi_bp-tallat100} we can observe, which we couldn't in figure \Cref{fig:host_listings_count}, that
...
Table \cref{tab:maximum_nights_avg_ntm} shows that the median for
