...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{screeplot} % PCA_inertia_cum
    \caption{PCA inertia}%
...
\newcommand{\factorialmap}[2]{
    \begin{figure}[H]
        ...
        %\parbox[b]{0.24\linewidth}{lorem ipsum dolor sit amet adescipng susisf jsdasj fsdlk ks aksjldsdf jkls}
        \includegraphics[width=0.85\linewidth]{plane_#1_#2-var}
...
\newcommand{\contrib}[2]{
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.85\linewidth]{plane_#1_#2-contrib}
...
\newcommand{\categorica}[4]{
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.85\linewidth]{ind_plane_#3_#1_#2}
