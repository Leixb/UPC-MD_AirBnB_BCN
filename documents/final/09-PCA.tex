...
Looking at \cref{fig:contrib_plane_#1-#2} we can see that the variables
with higher contribution are the ones about review scores and availability. As the review score variable arrows have a small angle
to the first factorial axis 
