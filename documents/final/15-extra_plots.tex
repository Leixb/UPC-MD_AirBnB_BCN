...
1,subsection,1,PCA Categorical variable centroids,sub:add_centroids
},pagecommand={\thispagestyle{plain}}
]{../../analysis/plots/centroides}

\includepdf[pages=-,landscape=true, addtotoc={
1,subsection,1,Cluster profiling comparison,sub:add_cluster_comp
},pagecommand={\thispagestyle{plain}}
]{../cluster_comparison/jam}

%\includepdf[pages=-,landscape=true, addtotoc={
%1,subsection,1,PCA Categorical variables projections,sub:add_fact_planes
%},pagecommand={\thispagestyle{plain}}
%]{../../analysis/plots/fact_planes}
